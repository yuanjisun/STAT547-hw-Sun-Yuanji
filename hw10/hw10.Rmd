...
It is a waste of time to get data one by one. I would like to enter all cities once and call the function only once. __This work is only designed for Chinese cities with a weather map, so the country code is only "CN". If you want to use this for other countries, the function needs to be modified slightly.__
```{r}
...
```{r}
city <- c("Beijing","Hangzhou","Shanghai","Xiamen","Chengdu","Harbin","Tianjin","Shijiazhuang","Xian","Jinan",
          "Zhenzhou","Wuhan","Guiyang","Changsha","Lanzhou","Kunming","Nanning","Guangzhou","Shenyang","Changchun",
          "Nanchang")
